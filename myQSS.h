...
inline QString PlayStyle()
{
    return "QPushButton"
   " {"
   "background-image:url(:/new/prefix1/pic/play.png);"
...
"    }"
  ...
  "  background-repeat:no-repeat;"
 "   background-position:center center;"
 "background-image:url(:/new/prefix1/pic/play_hover.png);"

   " }"
   " QPushButton:pressed{"
    "background-repeat:no-repeat;"
   " background-position:center center;"
   " background-image:url(:/new/prefix1/pic/play_click.png);"
...
inline QString PaseStyle()
{
    return "QPushButton"
   " {"
   "background-image:url(:/new/prefix1/pic/pause.png);"
 "   background-repeat:no-repeat;"
  "  background-position:center center;"
 "   border:none;"
...
"    }"
  ...
  "  background-repeat:no-repeat;"
 "   background-position:center center;"
 "background-image:url(:/new/prefix1/pic/pause_hover.png);"

   " }"
   " QPushButton:pressed{"
    "background-repeat:no-repeat;"
   " background-position:center center;"
   " background-image:url(:/new/prefix1/pic/pause_click.png);"
